...
CONF.register_opts(openstack_auth_opts, 'openstack_auth')
CONF.register_opts(openstack_deploy_manager_opts, 'openstack_deploy_manager')
CONF.register_opts(openstack_monitor_manager_opts, 'openstack_monitor_manager')
CONF.register_opts(rabbitmq_manager_opts, 'rabbitmq_manager')
